...
import com.shopping.jewellery.util.FileUtil;
import com.shopping.jewellery.validator.ProductValidator;
...
public class ManagementController {
	...
	public ModelAndView manageProduct(@RequestParam("name=success") String success) {
