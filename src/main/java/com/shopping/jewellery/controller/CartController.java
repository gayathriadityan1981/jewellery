...
import com.shopping.jewellery.services.CartServices;
...
public class CartController {
	...
	@RequestMapping("/show")
	public ModelAndView showCart(@RequestParam("name=cart") String result) {
		//the name gave some error as no value was assigned to it.so i hv given value as cart
